...
class AuctionListings(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name="auctioned_items")
...
class Bids(models.Model):
    ...
    auction = models.ForeignKey(AuctionListings, on_delete=models.CASCADE, related_name="item_bids")
...
class Comments(models.Model):
    ...
    auction = models.ForeignKey(AuctionListings, on_delete=models.CASCADE, related_name="item_comments")
...
class WatchList(models.Model):
    ...
    auction = models.ForeignKey(AuctionListings, on_delete=models.CASCADE, related_name="item_watchlists")
